    ...
    <div className="md:w-1/2 md:m-auto">
      ...
      <Paragraph>
        ...
        <span className="font-bold text-red-700">
          14 days after your last close contact with the person who had COVID-19
        </span>
        . You should stay away from others, especially people at higher risk for
        getting sick from COVID.  You should watch for fever, shortness of
        breath, or other symptoms of COVID-19. If you develop symptoms, stay
